    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="abhandler"
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			...
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABGeorgia.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
	        ...
	        <cfif url.deliverto EQ "home">
		        ...
		        <cfpdfformparam name="msta" value="GA">
		...
		<cfinclude template="../includes/thankYou/ga.cfm" >
