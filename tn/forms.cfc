<cfcomponent rest="true"
    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="abhandler"
		...
		<cfparam name="url.deliverto" default="home">
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			...
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABTennessee.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
	        ...
	        <cfif url.deliverto EQ "home">
		        ...
		        <cfpdfformparam name="msta" value="TN">
		...
		<cfinclude template="../includes/thankYou/tn.cfm" >
