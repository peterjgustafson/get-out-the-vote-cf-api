    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="abhandler"
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			<cfset fileName = "CTAbsenteeBallotApplication-#CreateUUID()#.pdf">
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABConnecticut.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
	        
	        <cfpdfformparam name="cust_fullname" value="#url.fname# #url.mname# #url.lname# #url.sfx#">
	        ...
	        <cfpdfformparam name="cust_dob" value="#url.cust_dobmonth#/#url.cust_dobday#/#url.cust_dobyear#">
	         ...
	         <cfpdfformparam name="cust_addressfull" value="#URLDecode(url.raddr1)# #URLDecode(url.raddr2)# #URLDecode(url.city)#, CT">
	        ...
	        <cfpdfformparam name="alt_sta" value="#url.alt_sta#">
			
			<cfpdfformparam name="email" value="#url.email#">
			<cfpdfformparam name="cust_telephone_full" value="#url.tel_num#">
			<cfpdfformparam name="cust_telephone_evening_num_full" value="#url.cust_telephone_evening_num_full#">
			<cfpdfformparam name="cust_fax" value="#url.cust_fax#">
			
			<cfpdfformparam name="cust_party_select_dropdown" value="#url.cust_party_select_dropdown#">
			
	        <!---<cfpdfformparam name="cust_election_dates" value="#url.cust_election_dates#">--->
		...
		<cfinclude template="../includes/thankYou/ct.cfm" >
...
<cfelse>
	<cfmail from="gotv@prosperitypac.com" subject="Voter Registration Form" to="#url.Email#" remove="true" server="smtp.postmarkapp.com" username="43a619df-47a9-45f0-83e6-9f003a81fe2b" password="43a619df-47a9-45f0-83e6-9f003a81fe2b" >
		...
		SELECT * FROM States WHERE State = 'WI';
		</cfquery>
