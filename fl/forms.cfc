...
<cffunction name="abhandler"
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			...
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABFlorida.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
			...
			<cfif url.deliverto EQ "cust_receive_ballot_by_mail_check">
		        ...
		        <cfpdfformparam name="msta" value="AK">
			...
			<cfif url.deliverto EQ "cust_receive_ballot_by_mail_check">
		        <cfpdfformparam name="cust_receive_ballot_by_mail_check" value="Yes">
			<cfelseif url.deliverto EQ "inPerson">
		        <cfpdfformparam name="cust_receive_ballot_by_in_person_check" value="Yes">
			<cfelse>
		        <cfpdfformparam name="cust_receive_ballot_individual_name_check" value="Yes">
			</cfif>
		...
		<cfinclude template="../includes/thankYou/fl.cfm" >
