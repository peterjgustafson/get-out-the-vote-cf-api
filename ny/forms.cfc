<cfcomponent rest="true"
    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="configHadler"
		...
		<cfparam name="url.cust_reason_absentee_list" default="">
		<cfparam name="url.cust_receive_ballot_individual_name" default="">
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			...
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABNewYork.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
			...
			<!---<cfif isDate("#url.cust_dobmonth#/#url.cust_dobday#/#url.cust_dobyear#")>
	    		<cfif len(cust_dobmonth) EQ 2><cfpdfformparam name="cust_dobmonth1" value="#left(cust_dobmonth,1)#"><cfelse><cfpdfformparam name="cust_dobmonth1" value="0"></cfif>
	    		<cfpdfformparam name="cust_dobmonth2" value="#right(cust_dobmonth,1)#">
	    		<cfif len(cust_dobday) EQ 2><cfpdfformparam name="cust_dobday1" value="#left(cust_dobday,1)#"><cfelse><cfpdfformparam name="cust_dobday1" value="0"></cfif>
	    		<cfpdfformparam name="cust_dobday2" value="#right(cust_dobday,1)#">
	    		<cfpdfformparam name="cust_dobyear1" value="#left(cust_dobyear,1)#">
	    		<cfpdfformparam name="cust_dobyear2" value="#mid(cust_dobyear,2,1)#">
	    		<cfpdfformparam name="cust_dobyear3" value="#mid(cust_dobyear,3,1)#">
	    		<cfpdfformparam name="cust_dobyear4" value="#right(cust_dobyear,1)#">
			</cfif>--->
	        ...
	        <cfif url.deliverto EQ "cust_receive_ballot_by_mail_check">
			...
			<cfpdfformparam name="cust_receive_ballot_individual_name" value="#url.cust_receive_ballot_individual_name#">
		...
		<cfinclude template="../includes/thankYou/ny.cfm" >
