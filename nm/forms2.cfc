<cfcomponent rest="true"
    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="abhandler"
		...
		<cfparam name="url.dob_year" default="1900">
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			...
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABNewMexico.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
            ...
            <cfpdfformparam name="dob_year" value="#url.dob_year#">
		...
		<cfinclude template="../includes/thankYou/nm.cfm" >
