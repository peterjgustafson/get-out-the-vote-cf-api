<cfcomponent rest="true"
    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="abhandler"
		...
		<cfparam name="url.cust_birthsta" default="">
        <cfparam name="url.cust_birthcountry" default="">
        <cfparam name="url.cust_county" default="">
        <cfparam name="url.cust_ballot_request_permanent" default="">
          
		
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			<cfset fileName = "AKAbsenteeBallotApplication-#CreateUUID()#.pdf">
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABArizona.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
            ...
            <cfpdfformparam name="cust_birthsta" value="#url.cust_birthsta#">
            <cfpdfformparam name="cust_birthcountry" value="#url.cust_birthcountry#">
            <cfpdfformparam name="cust_county" value="#url.cust_county#">
              
            <cfif url.cust_ballot_request_permanent EQ "Yes">
              <cfpdfformparam name="cust_ballot_request_permanent" value="Yes">
            </cfif>
	    </cfpdfform>
		...
		<cfinclude template="../includes/thankYou/az.cfm" >
