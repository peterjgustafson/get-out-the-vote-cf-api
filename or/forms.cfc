    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="abhandler"
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			...
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABOregon.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
            ...
            <cfif url.useMailingAddress EQ true>
              <cfpdfformparam name="maddr1" value="#URLDecode(url.maddr1)#">
		        ...
		        <cfpdfformparam name="msta" value="#URLDecode(url.msta)#">
	        ...
	        <cfif url.deliverto EQ "reg">
		        <cfpdfformparam name="alt_addr1" value="#URLDecode(url.raddr1)#">
                <cfpdfformparam name="alt_addr2" value="#URLDecode(url.raddr2)#">
                <cfpdfformparam name="alt_city" value="#URLDecode(url.city)#">
                <cfif structKeyExists(url, "rsta")><cfpdfformparam name="alt_sta" value="#URLDecode(url.rsta)#"><cfelse><cfpdfformparam name="alt_sta" value="#stateAbbr#"></cfif>
                <cfpdfformparam name="alt_zip5" value="#url.rzip5#">
            <cfelseif url.deliverto EQ "alt">
                <cfpdfformparam name="alt_addr1" value="#URLDecode(url.alt_addr1)#">
                <cfpdfformparam name="alt_addr2" value="#URLDecode(url.alt_addr2)#">
                <cfpdfformparam name="alt_city" value="#URLDecode(url.alt_city)#">
                <cfpdfformparam name="alt_sta" value="#URLDecode(url.alt_sta)#">
                <cfpdfformparam name="alt_zip5" value="#url.alt_zip5#">
			<cfelse>
		        <cfpdfformparam name="alt_addr1" value="#URLDecode(url.maddr1)#">
                <cfpdfformparam name="alt_addr2" value="#URLDecode(url.maddr2)#">
                <cfpdfformparam name="alt_city" value="#URLDecode(url.mcity)#">
                <cfpdfformparam name="alt_sta" value="#URLDecode(url.msta)#">
                <cfpdfformparam name="alt_zip5" value="#url.mzip5#">
			</cfif>
		...
		<cfinclude template="../includes/thankYou/or.cfm" >
