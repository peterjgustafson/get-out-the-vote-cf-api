    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="abhandler"
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			...
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABTexas.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
        ...
        <cfif Len(Trim(url.mname)) GT 0>
        <cfpdfformparam name="mname" value="#left(url.mname,1)#">
        </cfif> 
        <cfpdfformparam name="sfx" value="#url.sfx#">
        ...
        <cfpdfformparam name="raddr1" value="#URLDecode(url.raddr1)#">
        <cfpdfformparam name="raddr2" value="#URLDecode(url.raddr2)#">
        <cfpdfformparam name="rcity" value="#URLDecode(url.city)#">
        <cfpdfformparam name="rzip" value="#rzip5#">
        
		
        <cfif len(url.maddr1) NEQ 0> 
        	<cfpdfformparam name="maddr1" value="#URLDecode(url.maddr1)#">
        	<cfpdfformparam name="maddr2" value="#URLDecode(url.maddr2)#">
	        <cfpdfformparam name="mcity" value="#URLDecode(url.mcity)#">
	        <cfpdfformparam name="msta" value="#url.msta#">
	        <cfpdfformparam name="mzip" value="#url.mzip5#">
    	</cfif>
    
        <cfpdfformparam name="dob_month" value="#url.cust_dobmonth#">
        <cfpdfformparam name="dob_day" value="#url.cust_dobday#">
        <cfpdfformparam name="dob_year" value="#url.cust_dobyear#">
        
        <cfif url.deliverto NEQ "home">
            <cfpdfformparam name="#url.deliverto#" value="Yes">
        </cfif>
        
        
        <cfif url.cust_reason_absentee_list EQ "cust_reason_over_65_check" OR url.cust_reason_absentee_list EQ "cust_reason_disable_check">
       		<cfpdfformparam name="cust_application_for_general_check1" value="Yes">
		<cfelse>
        	<cfpdfformparam name="cust_application_for_general_check2" value="Yes">
		</cfif>
            
        <cfif url.deliverto EQ "cust_receive_ballot_relative_check">
        	<cfpdfformparam name="cust_receive_ballot_relative_name" value="#cust_receive_ballot_relative_name#">
		</cfif>
         
        <cfif url.deliverto EQ "cust_receive_ballot_outside_county_check">
	        <cfpdfformparam name="cust_receive_ballot_outside_county_arrive_month" value="#url.cust_receive_ballot_outside_county_arrivemonth#">
	        <cfpdfformparam name="cust_receive_ballot_outside_county_arrive_day" value="#url.cust_receive_ballot_outside_county_arriveday#">
	        <cfpdfformparam name="cust_receive_ballot_outside_county_arrive_year" value="#url.cust_receive_ballot_outside_county_arriveyear#">
	          
	        <cfpdfformparam name="cust_receive_ballot_outside_county_leave_month" value="#url.cust_receive_ballot_outside_county_leavemonth#">
	        <cfpdfformparam name="cust_receive_ballot_outside_county_leave_day" value="#url.cust_receive_ballot_outside_county_leaveday#">
	        <cfpdfformparam name="cust_receive_ballot_outside_county_leave_year" value="#url.cust_receive_ballot_outside_county_leaveyear#">
		</cfif>
		...
		<cfinclude template="../includes/thankYou/tx.cfm" >
