<cfcomponent rest="true"
    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="abhandler"
        ...
        <cfparam name="url.cust_reason" default="cust_reason_other_check">
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			...
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABNevada.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
	        ...
	        <cfif url.useMailingAddress EQ false>
		        ...
		        <cfpdfformparam name="msta" value="NV">
            ...
            <cfpdfformparam name="#url.cust_reason#" value="Yes">
            <cfif url.cust_reason EQ "cust_reason_military_domestic_check">
              <cfpdfformparam name="cust_reason_military_domestic_check" value="Yes">
            <cfelseif url.cust_reason EQ "cust_reason_military_overseas_check">
              <cfpdfformparam name="cust_reason_military_overseas_check" value="Yes">
            <cfelseif url.cust_reason EQ "cust_reason_overseas_check">
              <cfpdfformparam name="cust_reason_overseas_check" value="Yes">
            <cfelseif url.cust_reason EQ "cust_reason_over_65_check">
              <cfpdfformparam name="cust_reason_over_65_check" value="Yes">
            <cfelseif url.cust_reason EQ "cust_reason_disable_check">
              <cfpdfformparam name="cust_reason_disable_check" value="Yes">
            <cfelseif url.cust_reason EQ "cust_reason_other_check">
              <cfpdfformparam name="cust_reason_other_check" value="Yes">
            </cfif>
		...
		<cfinclude template="../includes/thankYou/nv.cfm" >
