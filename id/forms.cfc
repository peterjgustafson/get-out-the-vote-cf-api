    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="abhandler"
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			...
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABIdaho.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
	        <cfpdfformparam name="fname" value="#url.fname#">
	        <cfpdfformparam name="lname" value="#url.lname#">
            <cfpdfformparam name="fname2" value="#url.fname#">
	        <cfpdfformparam name="lname2" value="#url.lname#">
	        <cfpdfformparam name="email" value="#url.email#">
	        <cfif Len(Trim(url.mname)) GT 0>
	        <cfpdfformparam name="mname" value="#url.mname#">
            <cfpdfformparam name="mname2" value="#url.mname#">
	        </cfif>
	        <cfpdfformparam name="sfx" value="#url.sfx#">
            <cfpdfformparam name="sfx2" value="#url.sfx#">
			...
			<cfelse>
                ...
                <cfpdfformparam name="cust_county2" value="#url.cust_county#">
	    </cfpdfform>
		...
		<cfinclude template="../includes/thankYou/id.cfm" >
