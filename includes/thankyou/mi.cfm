		<cfinclude template="../sql/municipalityMailingAddressLookup.cfm" >
		
		<cfset addressLookupURL = "https://webapps.sos.state.mi.us/mivote/clerksearch.aspx">
		...
		<cfset formReturnData.ThankYou.ShowAdditionalInfo = "false">
		<!---<cfset formReturnData.ThankYou.AdditionalInfo = []> 
		<cfset formReturnData.ThankYou.AdditionalInfo[1] = "Add the reason why you qualify to vote absentee by mail">--->
