		...
		<cfset addressLookupURL = "http://tnsos.org/elections/election_commissions.php">
		...
		<cfset formReturnData.ThankYou.AdditionalInfo[1] = "Fill in your Social Security number">
		...
		<cfset arrayAppend(emailContent.emailBullets, "Fill in your your Social Security number")>
