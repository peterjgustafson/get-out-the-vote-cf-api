		...
		<cfset addressLookupURL = "http://sos.ga.gov/cgi-bin/countyregistrarsindex.asp">
		...
		<cfset formReturnData.ThankYou.AdditionalInfo[1] = "Fill in your driver's license number">
		...
		<cfset arrayAppend(emailContent.emailBullets, "Fill in your driver's license number")>
