		...
		<cfset addressLookupURL = "http://www.sos.mo.gov/elections/govotemissouri/localelectionauthority.aspx">
		...
		<cfset formReturnData.ThankYou.MailingAddressCount = "#getAddress.recordCount#">
		...
		<cfset arrayAppend(emailContent.emailBullets, "Fill in the last 4 digits of your Social Security number")>
