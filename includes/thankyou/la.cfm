		...
		<cfset addressLookupURL = "http://www.sos.la.gov/ElectionsAndVoting/Vote/Pages/RegistrarAddresses.aspx">
		...
		<cfset formReturnData.ThankYou.AdditionalInfo[1] = "Review and complete all additional required fields">
