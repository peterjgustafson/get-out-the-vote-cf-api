		...
		<cfset addressLookupURL = "http://www.sos.state.al.us/vb/election/all.aspx?trgtoffice=Circuit Clerk">
		...
		<cfset formReturnData.ThankYou.AdditionalInfo[1] = "Fill in your driver's license number or last 4 digits of your Social Security number">
		...
		<cfif getAddress.recordCount>
			...
			<cfif getAddress.county_name EQ "Jefferson">
				<cfset formReturnData.ThankYou.MailingAddress = "#formattedAddress#<br><br>Jefferson - Birmingham Division<br>Anne-Marie Adams<br>716 Richard Arrington Jr Blvd N, Room 400<br>Birmingham AL 35203<br>(205) 325-5355">
			</cfif>
		<cfelse>
		...
		<cfset arrayAppend(emailContent.emailBullets, "Fill in your driver's license number or last 4 digits of your Social Security number")>
