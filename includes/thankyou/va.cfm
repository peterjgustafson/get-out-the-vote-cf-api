		...
		<cfset addressLookupURL = "https://voterinfo.sbe.virginia.gov/PublicSite/(X(1)A(_ct5RWo3PPcv8ZN8tbfnliSh1CDw0HJCTmMSQUMla4BhSs8Y0nyAUyt-pkJylreKgdCUv7mJxjnS9RzvvoQ3X9B2eXDRCx0P_uPB00kQtvTMl1FWnhGLyDCtKkucYMDgY9p516JRukDoWsBju5_mx_RtnB41))/Public/FT2/PublicContactLookup.aspx?AspxAutoDetectCookieSupport=1">
		...
		<cfset formReturnData.ThankYou.AdditionalInfo[1] = "Fill in the last 4 digits of your Social Security number">
		...
		<cfelse>
			...
			<cfset emailContent.mailingAddress = "<a href=""https://voterinfo.sbe.virginia.gov/PublicSite/"">#addressLookupURL#</a>">
			<!--- Blank Footer  --->
		...
		<cfset arrayAppend(emailContent.emailBullets, "Fill in your last 4 digits of your Social Security number")>
