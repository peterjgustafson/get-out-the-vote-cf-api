		...
		<cfset addressLookupURL = "http://elections.delaware.gov/locations.shtml">
		...
		<cfset formReturnData.ThankYou.AdditionalInfo[1] = " Fill in your your Social Security number, which is optional">
		...
		<cfset arrayAppend(emailContent.emailBullets, "Fill in your Social Security number, which is optional")>
