		...
		<cfset addressLookupURL = "http://www.sos.state.oh.us/sos/elections/electionsofficials/boeDirectory.aspx">
		...
		<cfset arrayAppend(emailContent.emailBullets, "Fill in your driver's license number or last 4 digits of your Social Security number, send in a copy of a valid photo id, or any accepted document with your current address and name")>
