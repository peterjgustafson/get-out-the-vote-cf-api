		...
		<cfswitch expression="#authenitcationMethod#">
			...
			<cfcase value="keyAndSecret">
				...
				<cfif checkClientKeyAndSecret.recordCount>
					...
					<cfset clientId = checkClientKeyAndSecret.ClientId>
					<cfset userIsAuthorized = "true">
				</cfif>
			...
			<cfcase value="client">
				...
				<cfif structKeyExists(url, "authToken")>
					...
					<cfif checkToken.RecordCount>
						...
						SELECT     dbo.Clients_DomainNames.DomainName, dbo.Clients_Master.ClientId, dbo.Clients_Master.APISecret, dbo.Clients_Master.ClientId
						...
						<cfif checkClientSite.RecordCount>
							...
							<cfset userIsAuthorized = "true">
							<cfset clientId = checkClientSite.ClientId>
						</cfif>
					<cfelse>
					<cfscript>
