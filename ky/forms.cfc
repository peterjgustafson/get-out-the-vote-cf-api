    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="abhandler"
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			...
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABKentucky.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
            ...
            <!---<cfpdfformparam name="cust_reason_absentee_list" value="#url.cust_reason_absentee_list#"--->>
		...
		<cfinclude template="../includes/thankYou/ky.cfm" >
