    ...
    <!--- handle GET request (httpmethod),
     ...
     <cffunction name="abhandler"
		...
		<cflock type="exclusive" scope="server" timeout="#createTimeSpan(0,0,0,30)#">
			...
			<cfpdfform source="#getDirectoryFromPath(getCurrentTemplatePath())#ABCalifornia.pdf" destination="#getDirectoryFromPath(getCurrentTemplatePath())#temp\#fileName#" action="populate" overwriteData="true">
	        ...
	        <cfif url.deliverto EQ "home">
		        ...
		        <cfpdfformparam name="msta" value="CA">
            ...
            <cfpdfformparam name="cust_ballot_request_permanent" value="#url.cust_ballot_request_permanent#">
		...
		<cfinclude template="../includes/thankYou/ca.cfm" >
